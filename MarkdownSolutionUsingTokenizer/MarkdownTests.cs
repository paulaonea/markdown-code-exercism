...
public class MarkdownTests
{
    ...
    [Fact]
    public void With_markdown_symbols_in_the_header_text_that_should_be_interpreted()
    {
        var markdown = "# This is a __paragraph__ with _italic_ text";
        var expected = "<h1>This is a <strong>paragraph</strong> with <em>italic</em> text</h1>";
        Assert.Equal(expected, Markdown.Parse(markdown));
    }

    [Fact]
    public void With_two_lists()
    {
        var markdown =
            "# Start a list\n" +
            "* Item 1\n" +
            ...
            "* Item 2\n" +
            "End a list";
        var expected = "<h1>Start a list</h1>" +
                       "<ul><li>Item 1</li>" +
                       "<li>Item 2</li></ul>" +
                       "<p>End a list</p>" +
                       "<p>Start a list</p>" +
    ...
    [Fact]
    public void Unordered_lists_combined_with_headers()
    {
        var markdown =
            "# Start a list\n" +
            "* Item 1\n" +
